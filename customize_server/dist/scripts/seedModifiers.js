...
const seedModifiers = async () => {
    try {
        ...
        if (sizeGroup) {
            modifiers.push({ modifier_group_id: sizeGroup._id, name: 'Small', is_default: false, display_order: 1, price: 0 }, { modifier_group_id: sizeGroup._id, name: 'Medium', is_default: true, display_order: 2, price: 2.00 }, { modifier_group_id: sizeGroup._id, name: 'Large', is_default: false, display_order: 3, price: 4.00 });
        }
        // Sauce Selection
        ...
        if (toppingGroup) {
            modifiers.push({ modifier_group_id: toppingGroup._id, name: 'Cheese', display_order: 1, price: 1.50 }, { modifier_group_id: toppingGroup._id, name: 'Bacon', display_order: 2, price: 2.00 }, { modifier_group_id: toppingGroup._id, name: 'Mushrooms', display_order: 3, price: 1.00 }, { modifier_group_id: toppingGroup._id, name: 'Onions', display_order: 4, price: 0.50 });
        }
        // Spice Level
        ...
        await ModifierModel_1.ModifierModel.insertMany(modifierDocs);

...
const OrderItemModifierSchema = new mongoose_1.Schema({
    modifier_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Modifier', required: true },
    name_snapshot: { type: String, required: true },
    modifier_quantity_id: { type: mongoose_1.Schema.Types.ObjectId },
...
const OrderItemSchema = new mongoose_1.Schema({
    menu_item_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Item', required: true },
    size_id: { type: mongoose_1.Schema.Types.ObjectId },
...
const OrderMoneySchema = new mongoose_1.Schema({
...
const OrderDeliverySchema = new mongoose_1.Schema({
    name: { type: String },
    phone: { type: String },
    address: { type: mongoose_1.Schema.Types.Mixed }, // flexible object for address data
}, { _id: false });
